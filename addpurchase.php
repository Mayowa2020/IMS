<?php
    ...
    if($_POST) {
        ...
        $sql = "INSERT INTO purchases (inventory_id, purchase_price, quantity_purchased, vendor_id, user_id) VALUES ('$productId', '$purchasePrice', '$quantityPurchased', '$vendor', '$userId')";
